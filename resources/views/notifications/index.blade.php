        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if($unreadCount > 0)
                <span class="badge rounded-pill px-3 py-2"
                      style="background: #fdecea; color: #dc3545; font-size: 0.8rem;">
                ...
                <div class="d-flex align-items-start gap-3 px-4 py-4 border-bottom
                    ...
                    <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0"
                        ...
                        <i class="bi {{ $style['icon'] }}"
                           style="color: {{ $style['color'] }}; font-size: 1rem;"></i>
                    </div>
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-start justify-content-between gap-2">
                            ...
                            <form method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                        class="btn btn-sm btn-outline-danger rounded-3 px-2 py-1 flex-shrink-0"
                                        title="Delete">
