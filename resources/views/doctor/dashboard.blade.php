                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge rounded-pill"
                            style="background: #e7f1ff; color: #0d6efd; font-size: 0.75rem;">Today</span>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100"
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge rounded-pill"
                            style="background: #e0f7fc; color: #0097a7; font-size: 0.75rem;">Total</span>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div
                            class="list-group-item d-flex justify-content-between align-items-center py-3 px-4 border-0 border-bottom">
                            <div class="d-flex align-items-center gap-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold text-white flex-shrink-0"
                                    ...
                                    strtoupper(substr($appt->patient->last_name, 0, 1)) }}
                                </div>
                                <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 border-0 small">
                                        {{-- FIXED: Access patient through appointment relationship --}}
                                        {{ $record->appointment->patient->first_name ?? '' }}
                                        {{ $record->appointment->patient->last_name ?? '' }}
                                    </td>
