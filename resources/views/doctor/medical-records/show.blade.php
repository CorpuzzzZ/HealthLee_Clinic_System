                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold text-white flex-shrink-0"
                            ...
                            {{ strtoupper(substr($medicalRecord->appointment->patient->first_name, 0, 1)) }}{{
                            strtoupper(substr($medicalRecord->appointment->patient->last_name, 0, 1)) }}
                        </div>
                        <div>
                            <div class="fw-bold">
                                {{ $medicalRecord->appointment->patient->first_name }}
                                {{ $medicalRecord->appointment->patient->middle_name ?
                                $medicalRecord->appointment->patient->middle_name . ' ' : '' }}
                                {{ $medicalRecord->appointment->patient->last_name }}
                            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="p-2 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small">{{ $medicalRecord->appointment->patient->birthdate?->age
                                    ?? '—' }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-2 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small">{{ ucfirst($medicalRecord->appointment->patient->gender ??
                                    '—') }}</span>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="p-2 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small">{{
                                    $medicalRecord->appointment->patient->user->contact->contact_number ?? '—' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            <div class="p-2 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small">
                                    {{ \Carbon\Carbon::parse($medicalRecord->appointment->appointment_time)->format('h:i
                                    A') }}
                                </span>
                            </div>
                        </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                    ...
                    <small class="text-muted">
                        Recorded by Dr. {{ $medicalRecord->appointment->doctor->first_name }} {{
                        $medicalRecord->appointment->doctor->last_name }}
                    </small>
                </div>
