                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small">{{ ucfirst($appointment->patient->gender ?? '—') }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Age</small>
                                <span class="fw-medium small">{{ $appointment->patient->age ?? '—' }}</span>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Contact</small>
                                <span class="fw-medium small">{{ $appointment->patient->contact_number ?? '—' }}</span>
                            </div>
                        </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                ...
                <div class="card-body p-4">
                    ...
                    @else
                        ...
                        <form method="POST"
                              action="{{ route('doctor.appointments.status', $appointment) }}">
                            @csrf
                            @method('PATCH')
