                ...
                <div class="card-body p-4">
                    ...
                    @if($user->role === 'admin')
                        <span class="badge rounded-pill px-3 py-2"
                              style="background: #e7f1ff; color: #0d6efd;">
                    ...
                    @else
                        <span class="badge rounded-pill px-3 py-2"
                              style="background: #e8f5ee; color: #198754;">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                    ...
                                    <span class="fw-medium small">{{ $profile->contact_number ?? '—' }}</span>
                                </div>
                            </div>
                            @if($user->role === 'doctor')
                                <div class="col-sm-4">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                    ...
                                    <span class="fw-medium small">{{ $profile->street ?? '—' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                    <small class="text-muted d-block mb-1">Barangay</small>
                                    <span class="fw-medium small">{{ $profile->barangay ?? '—' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                    <small class="text-muted d-block mb-1">City</small>
                                    <span class="fw-medium small">{{ $profile->city ?? '—' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                    <small class="text-muted d-block mb-1">Province</small>
                                    <span class="fw-medium small">{{ $profile->province ?? '—' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                    <small class="text-muted d-block mb-1">Zip Code</small>
                                    <span class="fw-medium small">{{ $profile->zip_code ?? '—' }}</span>
                                </div>
                            </div>
                        </div>
