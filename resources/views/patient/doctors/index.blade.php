<x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h5 class="fw-bold mb-0 text-primary fs-3">Find a Doctor</h5>
        ...
        <div class="card-body px-4 py-3">
            <form method="GET" action="{{ route('patient.doctors.index') }}" class="row g-2 align-items-end">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            class="form-control border-start-0 ps-0" placeholder="Doctor name...">
                    </div>
                </div>
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('patient.doctors.index') }}" class="btn btn-outline-secondary px-3">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold text-white flex-shrink-0"
                            ...
                            {{ strtoupper(substr($doctor->first_name, 0, 1)) }}{{ strtoupper(substr($doctor->last_name,
                            0, 1)) }}
                        </div>
                        <div>
                            <div class="fw-bold">
                        ...
                        <div class="col-6">
                            <div class="p-2 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small" style="color: #198754;">
                                    {{ $doctor->availabilities->where('available_date', '>=', today())->count() }}
                                    slot(s)
                                </span>
                            </div>
                        </div>
                    ...
                    @if($nextSlot)
                    <div class="p-2 rounded-3 mb-3" style="background: #e8f5ee; border-left: 3px solid #198754;">
                    ...
                    @else
                    <div class="p-2 rounded-3 mb-3" style="background: #f8f9fa; border-left: 3px solid #dee2e6;">
