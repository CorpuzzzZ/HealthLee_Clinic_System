<x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h5 class="fw-bold mb-0 text-primary fs-3">
            ...
            <div class="card border-0 shadow-sm h-100"
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge rounded-pill"
                            style="background: #e0f7fc; color: #0097a7; font-size: 0.75rem;">Soon</span>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100"
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge rounded-pill"
                            style="background: #e8f5ee; color: #198754; font-size: 0.75rem;">Done</span>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100"
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge rounded-pill"
                            style="background: #fdecea; color: #dc3545; font-size: 0.75rem;">Cancelled</span>
                    </div>
    ...
    <div class="row g-4 mb-4">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-semibold">{{ $patient->birthdate?->age ?? 'N/A' }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                        ...
                        <div class="col-12">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-semibold">{{ $patient->user->contact->contact_number ?? 'Not provided'
                                    }}</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-header border-0 py-3 px-4" style="background: #ffc107; border-radius: 12px 12px 0 0;">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold text-white flex-shrink-0"
                                    ...
                                    {{ strtoupper(substr($appt->doctor->first_name, 0, 1)) }}{{
                                    strtoupper(substr($appt->doctor->last_name, 0, 1)) }}
                                </div>
                                <div>
