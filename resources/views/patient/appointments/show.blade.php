                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <div class="fw-bold">
                                ...
                                {{ $appointment->doctor->middle_name ? $appointment->doctor->middle_name . ' ' : '' }}
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                ...
                                <span class="fw-medium small">{{ ucfirst($appointment->doctor->gender ?? '—') }}</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: #f8f9fa;">
                                <small class="text-muted d-block mb-1">Contact</small>
                                <span class="fw-medium small">{{ $appointment->doctor->contact_number ?? '—' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-header border-0 py-3 px-4"
                    ...
                    <h6 class="mb-0 fw-semibold text-white">
                        <i class="bi bi-sticky-fill me-2"></i> Your Notes
                    </h6>
                </div>
                <div class="card-body p-4">
                    ...
                    @else
                        <div class="text-center py-3 text-muted">
                            <i class="bi bi-sticky fs-2 d-block mb-2 opacity-25"></i>
                            <small>No notes added for this appointment.</small>
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="card-body px-4 pb-4 pt-3">
                        <div class="row g-3">
                            ...
                            @if($appointment->medicalRecord->notes)
                                <div class="col-12">
                                    <div class="p-3 rounded-3"
                                         style="background: #f8f9fa; border-left: 3px solid #ffc107;">
